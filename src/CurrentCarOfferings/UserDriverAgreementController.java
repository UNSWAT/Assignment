 ...
 * @author Preet
 */
public class UserDriverAgreementController implements Initializable {
                ...
                if (member.next()){
                    membertype = member.getString(1);                    
                        ...
                        try {
                            ...
                            Logger.getLogger(UserDriverAgreementController.class.getName()).log(Level.SEVERE, null, ex);
                        }                         
