 ...
 * @author Preet
 */
public class EnterDestinationAndLocationController implements Initializable {
                ...
                if (member.next()){
                    membertype = member.getString(1);                    
                        ...
                        try {
                            ...
                            Logger.getLogger(EnterDestinationAndLocationController.class.getName()).log(Level.SEVERE, null, ex);
                        }                         
