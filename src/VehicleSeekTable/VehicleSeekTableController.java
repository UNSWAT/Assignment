 ...
 * @author Preet
 */
public class VehicleSeekTableController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try{
            ...
            getOffers = con.prepareStatement("select MEMBER_USERNAME,POSTCODE_FROM,POSTCODE_TO, TIME_FROM, TIME_TO, QUOTA, CARTYPE, OFFER_ID from OFFER WHERE CARTYPE= ? ");
            getOffers.setString(1,OtherStaticVariables.getVehicle());
...
try {
            ...
            Logger.getLogger(VehicleSeekTableController.class.getName()).log(Level.SEVERE, null, ex);
        }        
    }
